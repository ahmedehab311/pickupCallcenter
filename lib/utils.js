...
export const selectStyles = (theme,color) => ({
  ...
  option: (provided, state) => ({
    ...
    //   : "transparent",
      backgroundColor: state.isSelected
    ? theme === "dark"
      ? "rgba(59, 130, 246, 0.4)"   // أزرق غامق للـ selected (في الداكن)
      : "rgba(59, 130, 246, 0.2)"   // أزرق فاتح للـ selected (في الفاتح)
    : state.isFocused
    ? theme === "dark"
      ? "rgba(59, 130, 246, 0.2)"   // Hover غامق أخف
      : "rgba(59, 130, 246, 0.1)"   // Hover فاتح أخف
    : "transparent",
